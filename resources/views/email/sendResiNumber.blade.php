...
<body style="background: #f3f3f3;margin:0;padding:0">
    ...
    <h2 style="color:#fff;font-family: 'Yanone Kaffeesatz', sans-serif;text-transform:uppercase;letter-spacing:1px">Informasi Nomor Resi Ticket</h2>
    </td>
    </tr>
    <tr>
    <td colspan="2">
    ...
    <font style="font-family: 'Nunito', sans-serif;color:#000080; font-size:16px;">Halo <b>{{$name}}</b>, terima kasih telah memesan ticket di E-Ticket Persib<br/>
    Berikut akan kami informasikan Nomor Resi ticket Anda :</font>
    ...
    <span style="color:#000080;font-weight:bold;">{{$resi}}</span>
    </td>
    </tr>
    <tr>
        <td>&nbsp;</td>
    ...
    <p style="font-family: 'Nunito', sans-serif;color:#000080; font-size:24px;">
    <b>Bagimu PERSIB Jiwa Raga Kami</b>
    </p>
    </td>
    </tr>
    </tbody>
