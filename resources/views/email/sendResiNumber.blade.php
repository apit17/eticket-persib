...
<body style="background: #f3f3f3;margin:0;padding:0">
    ...
    <h2 style="color:#fff;font-family: 'Yanone Kaffeesatz', sans-serif;text-transform:uppercase;letter-spacing:1px">Informasi Nomor Resi Kissproof.id</h2>
    </td>
    </tr>
    <tr>
    <td colspan="2">
    ...
    <font style="font-family: 'Nunito', sans-serif;color:#000000; font-size:16px;">Halo <b>{{$name}}</b>, terima kasih telah berbelanja di Kissproof.id<br/>
    Berikut akan kami informasikan Nomor Resi JNE pesanan Anda :</font>
    ...
    <span style="color:#AC124C;font-weight:bold;">{{$resi}}</span>
    </td>
    </tr>
    <tr>
        <td>&nbsp;</td>
